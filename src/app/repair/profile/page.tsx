...
export default function ManagerProfile () {
  return(
    <div className="justify-center w-[375px] h-[736px] pt-[24px] shrink-0 rounded-t-[24px] bg-white font-Pretendard">
      <div className="inline-flex items-start gap-[264px] w-[375px] h-[24px] px-[20px] shrink-0 bg-white">
        <div className="w-[47px] h-[24px] align-text-top text-gray-900 text-[18px] leading-6 font-bold">담당자</div>
        <Image
              src="/icons/close.svg"
              width={24}
              height={24}
      ...
      {/* <div className="flex mx-[auto] mt-[66px] w-[72px] h-[72px] rounded-full shrink-0 drop-shadow-md bg-gray-300 shadow-profile">
        <Image
              className="top-[14.6px] mx-[auto]"
      ...
      <div className="flex mt-[8px] justify-center  text-[18px] leading-[24px] font-medium">점심시간 13:00 ~ 14:00</div>
      <div className="grid mt-[24px] mx-[auto] justify-center w-[311px] h-[222px] shrink-0 rounded-[24px] gap-[8px] px-[32px] py-[24px] bg-gray-100 shadow-primary text-base ">
        ...
        <div className="flex gap-[8px]">
          ...
          <button className="text-[14px] font-normal text-[#216FD6]">복사</button>
        </div>
        <div className="flex gap-[8px]">
      ...
      <div className="flex pt-[48px] justify-center gap-[10px] text-base font-medium">
        <button className="flex items-center justify-center gap-[4px] w-[166px] h-[52px] rounded-[16px] shrink-0 bg-white border border-blue-500 text-blue-700">
        <IconMessages color="#1D4ED8" width="20" height="20"></IconMessages> 메일보내기</button>
        <button className="flex items-center justify-center gap-[4px] w-[166px] h-[52px] rounded-[16px] shrink-0 bg-blue-700 text-white">
        <IconPhone color="#FFFFFF" width="20" height="20"></IconPhone> 전화걸기</button>
      </div>
    </div>
  )
}