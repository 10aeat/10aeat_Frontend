  ...
  return (
    <div className="relative w-full bg-white">
      ...
      <div className="flex">
        ...
        <div className="flex flex-col items-start gap-4 top-28 left-64">
          <div className="flex flex-col items-start relative self-stretch w-full flex-[0_0_auto] mt-[32px]">
          ...
          <p className="self-stretch font-Pretendard text-[14px] font-normal leading-[20px] capitalize text-gray-900">
            법정 시설물 유지관리 점검 사안은 오피스너 서비스를 통해 소유자에게
            노출됩니다. <br />
